...
async def run_examples():
    ...
    print("UI example moved to examples/ui_example.py")
...
if __name__ == "__main__":
    if len(sys.argv) > 1:
        ...
        if example_name == "basic":
            ...
            print("UI example moved to examples/ui_example.py. Run it directly.")
            ...
            print("Available examples: basic, tools, custom, chat, local, override, tool_chat")
    else:
        # Run all examples
